...
Scheme
{
	...
	{
		// base colors
		"BaseText"			"80 248 64 248"	// used in text windows, lists
		"BrightBaseText"		"80 248 64 248"	// brightest text
		"SelectedText"		"80 248 64 248"	// selected text
		"DimBaseText"		"80 248 64 248"	// dim base text
		"LabelDimText"		"80 248 64 164"	// used for info text
		"ControlText"		"80 248 64 248"	// used in all text controls
		"BrightControlText"	"80 248 64 248"	// use for selected controls
		"DisabledText1"		"80 248 64 248"	// disabled text
		"DisabledText2"		"0 0 0 0"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"80 248 64 248"	// offline friends, unsubscribed games, etc.
		...
		"SelectionBG"		"80 248 64 100"	// background color of any selected text or menu item
		"SelectionBG2"		"80 248 64 16"		// selection background in window w/o focus
		...
		// Credits ------------------------------------------------
		"CreditsNormalFG"	"80 248 64 248"
		"CreditsNormalBG"	"0 0 0 248"

		"CreditsTitleFG"	"80 248 64 248"
		"CreditsTitleBG"	"0 0 0 248"

		"CreditsStudioTitleFG"	"80 248 64 248"
		"CreditsStudioTitleBG"	"0 0 0 248"

		"CreditsIndividualTitleFG"	"80 248 64 248"
		"CreditsIndividualTitleBG"	"0 0 0 248"
		// --------------------------------------------------------

		// titlebar colors
		"TitleText"			"80 248 64 248"
		"TitleDimText"		"80 248 64 248"
		"TitleBG"			"80 248 64 248"
		"TitleDimBG"		"80 248 64 248"
		"TitleIcon"		"255 255 64 248" // big '!' icon in top left
		
		// slider tick colors
		"SliderTickColor"		"128 140 128 248"
		"SliderTrackColor"	"80 80 80 248"

		// border colors
		"BorderBright"		"80 248 64 128"	// the lit side of a control
		"BorderDark"		"80 248 64 128"	// the dark/unlit side of a control
		"BorderSelection"		"80 248 64 128"	// the additional border color for displaying the default/selected button
		"BorderBuyPreset"		"80 248 64 248"	// the lit side of a control

		"team0"			"204 204 204 255" // Spectators
		"team1"			"255 64 64 255" // CT's
		"team2"			"154 204 255 255" // T's

		// Statistics text
		"StatisticsText"		"80 248 64 248"
		"SelectedStatisticsText"	"128 128 128 255"

		"BuyPresetBG"			"0 0 0 64"
		"BuyPresetAltBG"		"0 0 0 128"

		"MapDescriptionText"	"80 248 64 248" // the text used in the map description window
	}
